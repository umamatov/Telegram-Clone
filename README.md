# Telegram-Clone
## This is the telegram app ui clone for ios devices, And this is only developed for leraning purpose. And this is developed using pure uikit widgets programatically. If you  
1. Main Page
